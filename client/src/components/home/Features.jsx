...
// // again got this directly from prebuilt UI
        ...
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <div className="flex flex-col md:flex-row items-center xl:-mt-10">
                ...
                >
                        ...
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300 flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">
                                    Get instant AI recommendations to improve your summary, skills, and experience sections.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">
                                    Our resumes are designed to pass Applicant Tracking Systems used by top recruiters.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            <svg className="size-6 stroke-orange-600" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                                <path d="M12 15V3" />
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">
                                    Choose templates, colors, and layouts to create a resume that matches your personal brand.
                                </p>
                            </div>
                        </div>
                    </div>
